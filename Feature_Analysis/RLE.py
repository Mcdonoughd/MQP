...
Run Length Encoding by Daniel McDonough

This script has several encoders and decoders
over different run lengths.
This was going to be one of our features
but we could not get this to work properly
