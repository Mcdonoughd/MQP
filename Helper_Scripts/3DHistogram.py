...
#
print(os.getcwd())
data_array = cv2.imread("./single_img.tif",1)
...
x_data, y_data = np.meshgrid( np.arange(g.shape[1]), np.arange(g.shape[0]) )
...
y_data = y_data
z_data = g
ax.plot_wireframe( x_data,
          y_data,
          z_data,rstride=5, cstride=5)
#
