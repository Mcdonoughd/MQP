...
Sauvola Segemntation
by Daniel Mcdonough

Given a location to an image this script
will produce Sauvola segmentation
...
def obtainLabels(img):
    ...
    labels, num = ndi.label(cells_cleaned_s, structure=np.ones((3, 3)))
...
def getGroundTruths(dataset):
    ...
    df.to_csv("Otsu_Segmentation_report.csv")
